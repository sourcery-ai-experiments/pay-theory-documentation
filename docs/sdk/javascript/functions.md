...
- `styles`: (Object)
  - see the [Styles object](/docs/main/getting_started/styling_pay_theory_fields.mdx) for more details
...
- **reason** (Object):
  - **failure_code** (String): The failure code for the failure. You can find a list of failure codes [here](failed_transactions)
...
- **message** (String): The error message. The string will begin with one of the codes shown [here](ERRORS)
