...
In this Quickstart, you will learn how to create, initiate, and test a payment.
  ...
  <Admonition type="danger"  title="Before you start">
    <p>You will need access to your Pay Theory Sandbox. If you do not have a sandbox account, you can request one here.</p>
