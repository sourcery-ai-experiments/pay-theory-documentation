...
<Tabs
  ...
  <Admonition type="danger"  title="Before you start">
    ...
    <a href= "../OnlinePayments/Getting%20Started/Quickstart#6-once-the-fields-are-valid-run-transaction" class="button button--primary button--md">Transact function</a>
  </Admonition>
