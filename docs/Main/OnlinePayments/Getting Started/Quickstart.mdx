...
<Tabs
  ...
  <Admonition type="note"  title="Before you start">
    <p>You will need access to your Pay Theory Sandbox. If you do not have a sandbox account, you can create one here.</p>
  ...
  ***
  ...
  <Admonition type="note"  title="Find your API Key from Pay Theory Portal">
    <p>There may be cases where you may find it difficult to get your API Key from the portal. You can follow the below steps for easily finding it.</p>
    <p>  
      <ol>
